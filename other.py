...
# наполнили таблицу p1 в базе данных people.db данными из прошлой версии реализации
# with sq.connect("people.db") as con:
#     cur = con.cursor()
#     # cur.execute("DELETE FROM p1")
#     for obj1, obj2 in zip(lst_person, dict_obj):
#         cur.execute("INSERT INTO p1 VALUES(NULL, ?, ?, ?)", (obj1.name, " ".join(obj2), obj1.birthday))
pass
with sq.connect("people.db") as con:
    cur = con.cursor()
    cur.execute("SELECT name FROM p1")